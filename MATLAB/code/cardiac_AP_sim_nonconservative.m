...
sim_result_dir = [storage_dir 'nonconservative_stim_result' filesep];
...
if run_simulation
    ...
    for i_segment = 1:num_segments
        ...
        if i_segment == 1
            [VOI, STATES] = cardiac_AP_exported(tspan,'ncs');
        else
            [VOI, STATES] = cardiac_AP_exported(tspan,'ncs',X0);
        end
        toc
        ...
        save([sim_result_dir 'AP_sim_states_ncs_' num2str(i_segment) '.mat'],'VOI','STATES');   
    end
end
