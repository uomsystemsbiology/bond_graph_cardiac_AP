...
sim_result_dir = [storage_dir 'nonconservative_stim_result_var' filesep];
...
if run_simulation
    ...
    for i_segment = 1:num_segments
        ...
        if i_segment == 1
            [VOI, STATES] = cardiac_AP_exported_var(tspan,'ncs');
        else
            [VOI, STATES] = cardiac_AP_exported_var(tspan,'ncs',X0);
        end
        toc
